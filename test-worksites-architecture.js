...
const server = (fs.readFileSync('server.js', 'utf8') + fs.readFileSync('app/createApplication.js', 'utf8')); const route = fs.readFileSync('routes/worksites.js', 'utf8'); const service = fs.readFileSync('services/worksitesService.js', 'utf8');
