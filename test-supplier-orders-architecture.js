...
assert(server.indexOf("app.post('/tasks/delete'") < server.indexOf('registerSupplierOrderCompletionRoutes(app'));
assert(server.indexOf('registerSupplierOrderCompletionRoutes(app') < server.indexOf("app.post('/agenda/add'"));
...
assert(server.includes("app.post('/tasks'"));
